        ...
        <main className="space-y-6 px-4 py-5 md:px-6 lg:px-8">
          <header className="flex flex-col gap-4 border-b border-line pb-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-semibold text-white">Document comparison dashboard</h1>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              {dashboard.comparison_id ? (
                <>
          ...
          <UploadPanel onSubmit={handleUpload} busy={busy} status={status} />
